...
const products = [
  {
    ...
    description:
      "Kemeja bekas pilihan yang dikreasikan menjadi model boxy modern dengan potongan nyaman dan stylish.",
    stock: 5,
  },
  {
    id: 2,
    ...
    description:
      "Kemeja vintage dengan sentuhan kancing Cheongsam yang unik untuk tampilan berbeda dan penuh karakter.",
    stock: 4,
  },
  {
    id: 3,
    ...
    description:
      "Kemeja boxy bernuansa earth tone yang cocok untuk gaya kasual, minimalis, dan modern.",
    stock: 6,
  },
  {
    id: 4,
    ...
    description:
      "Kemeja putih klasik yang dikreasikan dengan detail kancing Cheongsam untuk tampilan minimalis dan elegan.",
    stock: 3,
  },
  {
    id: 5,
    ...
    description:
      "Kemeja boxy premium berwarna olive dengan desain eksklusif dan potongan modern.",
    stock: 5,
  },
  {
    id: 6,
    ...
    description:
      "Kemeja motif garis biru dengan sentuhan kancing Cheongsam yang memberikan karakter unik.",
    stock: 4,
  },
  {
    id: 7,
    ...
    description:
      "Kemeja boxy bergaya monochrome yang mudah dipadukan untuk berbagai gaya outfit.",
    stock: 5,
  },
  {
    id: 8,
    ...
    description:
      "Kemeja bernuansa dark forest dengan detail kancing Cheongsam untuk tampilan eksklusif.",
    stock: 2,
  },
  {
    id: 9,
    ...
    description:
      "Koleksi terbatas Clottfits.page dengan desain boxy eksklusif dan jumlah produksi terbatas.",
    stock: 2,
  },
  {
    id: 10,
    ...
    description:
      "Koleksi limited edition dengan warna navy dan detail kancing Cheongsam yang unik.",
    stock: 1,
  },
  {
    id: 11,
    ...
    description:
      "Kemeja boxy bernuansa sandstone dengan karakter kasual yang mudah dipadukan.",
    stock: 3,
  },
  {
    id: 12,
    ...
    description:
      "Koleksi reworked bernuansa gelap dengan detail unik untuk tampilan istimewa.",
    stock: 2,
  },
];
...
function filterProducts() {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    if (priceValue === "middle") {
      matchPrice = product.price >= 150000 && product.price <= 200000;
    }
...
function addToCart(productId) {
  ...
  if (existingItem) {
    if (existingItem.quantity < product.stock) {
      ...
      showToast("Jumlah produk sudah mencapai batas stok.");
